...
class RegistrationAgentAdministratifFormType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\AgentAdministratif'
        ));
    }

    public function getBlockPrefix()
    {
        return 'agent_administratif_registrationtype';
    }
}
